    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    @if(App::isLocale('ar'))
                    <span>{{__('dashboard.Sliders')}} {{$resturant_id->translate('ar')->name}}</span>
                    @else
                    <span>{{$resturant_id->translate('en')->name}} {{__('dashboard.Sliders')}}</span>
                    @endif
                    <i class="fa fa-circle"></i>
                </li>
                <li>
                    <span>{{__('dashboard.Create branch')}}</span>
                </li>
            </ul>
        ...
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h1 class="page-title">{{__('dashboard.Create branch Form')}}
        </h1>
        <!-- END PAGE TITLE-->
        <!-- END PAGE HEADER-->
            ...
            <div class="col-md-12">
                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    ...
                    <div class="portlet-body">
                        <!-- BEGIN FORM-->
                        <form action="{{route('resturant.branches.store',$resturant_id->id)}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            <input name="resturant_id" type="hidden" value="{{$resturant_id->id}}">
                            <div class="form-body">
