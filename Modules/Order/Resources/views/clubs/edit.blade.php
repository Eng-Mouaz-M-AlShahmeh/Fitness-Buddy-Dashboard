            ...
            <div class="col-md-12">
                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    ...
                    <div class="portlet-body">
                        <!-- BEGIN FORM-->
                        <form action="{{route('order.club.update',$order->id)}}" method="post" id="form_sample_1" class="form-horizontal">
                            @csrf
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="created_at"
                                               ...
                                               placeholder="{{$order->created_at}}" data-required="1" class="form-control" disabled /> </div>
                                </div>
                                
                                <div class="form-group">
                                    <label class="control-label col-md-3">{{__('dashboard.Updated At')}}
                                        <span class="required"> * </span>
                                    </label>
                                    <div class="col-md-4">
                                        <input type="text" name="updated_at"
                                               value="{{$order->updated_at}}"
                                               placeholder="{{$order->updated_at}}" data-required="1" class="form-control" disabled /> </div>
                                </div>
                                
                                
                                
                                <div class="form-group">
                                    <label class="control-label col-md-3">{{__('dashboard.Ended At')}}
                                        <span class="required"> * </span>
                                    </label>
                                    <div class="col-md-4">
                                        <input type="text" name="ended_at"
                                               value="{{$order->ended_at}}"
                                               placeholder="{{$order->ended_at}}" data-required="1" class="form-control" disabled /> </div>
                                </div>
                                
                                
                                
                                <div class="form-group">
                                    <label class="control-label col-md-3">{{__('dashboard.Subscription Period in Days')}}
                                        <span class="required"> * </span>
                                    </label>
                                    <div class="col-md-4">
                                        <input type="text" name="period_days"
                                               value="{{$order->subscription->period_days}}"
                                               placeholder="{{$order->subscription->period_days}}" data-required="1" class="form-control" disabled /> </div>
                                </div>
                                -->
...
<script>
function cancel() {
  location.replace("https://fitness-buddy.com/order/clubs")
}
</script>
