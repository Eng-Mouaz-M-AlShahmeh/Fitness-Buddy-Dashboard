    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="{{route('order.resturants.work')}}">{{__('dashboard.Work Lunch')}}</a>
                        ...
                        <div class="caption">
                            ...
                            <div class="btn-group">
                                   <div class="btn-group">
                                    ...
                                    <div class="btn-group">
                                        <a href="{{route('order.resturants.monthly')}}" class="btn btn-info">
                                         {{__('dashboard.Monthly Plan')}}
                                        </a>
                                    </div>
                                    <div class="btn-group">
                                        <a href="{{route('order.resturants.work')}}" class="btn btn-warning">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <!--
                                                   ...
                                                   <a href="{{ route('order.resturants.editWork',[$order->id]) }}" class="btn btn-info btn-sm">
...
function pause(id){
  location.replace("https://fitness-buddy.com/order/editWork/"+id)
}
