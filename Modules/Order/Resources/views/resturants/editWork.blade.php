            ...
            <div class="col-md-12">
                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    ...
                    <div class="portlet-body">
                        <!-- BEGIN FORM-->
                        <form action="{{route('order.resturants.updateWork',$order->id)}}" method="post" id="form_sample_1" class="form-horizontal">
                            @csrf
                            <div class="form-body">
...
<script>
function cancel() {
  location.replace("https://fitness-buddy.com/order/resturants/work")
}
</script>
