...
<div class="page-content">
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{route('clubcontact.index')}}">{{__('dashboard.Clubs Contacts')}}</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span>{{__('dashboard.Clubs Contacts Details')}}</span>
            </li>
        </ul>
    ...
    <!-- BEGIN PAGE TITLE-->
    <h1 class="page-title">{{__('dashboard.Clubs Contacts Details Form')}}
    </h1>
    <!-- END PAGE TITLE-->
    <!-- END PAGE HEADER-->
                ...
                <div class="portlet-body">
                    ...
                    <form id="form_sample_1" class="form-horizontal" >
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3">{{__('dashboard.Club')}}

                                </label>
                                <div class="col-md-4">
                                    <input type="text"
                                           value="{{$contacts->club->name}}"
                            ...
                            <div class="form-actions">
                               ...
                               -->         
                                    ...
                                    <a href="{{ route('clubcontact.pdf',[$contacts->id]) }}" class="btn btn-info"><i class="fa fa-download"></i> {{__('dashboard.Generate PDF')}}</a>
                                        
                                   
                                         
                                        
                                        
                                        <a href="{{route('clubcontact.index')}}" type="submit" class="btn green">{{__('dashboard.Back')}}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
