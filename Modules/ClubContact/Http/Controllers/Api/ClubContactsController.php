...
namespace Modules\ClubContact\Http\Controllers\Api;
...
class ClubContactsController extends Controller
{
    /**
    ...
    public function insertContactForm(Request $request)
    {
        $validator = Validator::make($request->all(),
            array('club_id','subject'=>'required','msg'=>'required'));
        if ($validator->fails()) {
        ...
        ClubContact::create($request->all());
        return response()->json([
            'status' => true,
