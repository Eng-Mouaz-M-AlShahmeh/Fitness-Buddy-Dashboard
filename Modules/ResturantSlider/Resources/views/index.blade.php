    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="{{route('resturant.sliders.index')}}">{{__('dashboard.Resturants sliders')}}</a>
                </li>
            </ul>
        ...
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h1 class="page-title">{{__('dashboard.Resturants Sliders Datatable')}}
        </h1>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            <a href="{{ route('resturant.sliders.create') }}" class="btn btn-primary"><i class="fa fa-plus-square"></i></a>
                        </div>
                    ...
                    <div class="portlet-body">
                        <div class="table-container">
                            <table class="table table-striped table-bordered table-hover" id="sample_3">
                                ...
                                <tbody>
                                @foreach ($resturantsSliders as $key=>$resturant)
                                    <tr>
                                        <td> {{$key+1}} </td>
                                        <td> {{$resturant->resturant->name}} </td>
