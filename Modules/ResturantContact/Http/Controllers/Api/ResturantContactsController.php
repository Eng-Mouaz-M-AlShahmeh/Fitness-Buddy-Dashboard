...
namespace Modules\ResturantContact\Http\Controllers\Api;
...
class ResturantContactsController extends Controller
{
    /**
    ...
    public function insertContactForm(Request $request)
    {
        $validator = Validator::make($request->all(),
            array('rest_id','subject'=>'required','msg'=>'required'));
        if ($validator->fails()) {
        ...
        ResturantContact::create($request->all());
        return response()->json([
            'status' => true,
    ...
    {
        return view('resturantcontact::show');
    }
