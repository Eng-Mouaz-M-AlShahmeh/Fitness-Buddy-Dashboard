    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <span>{{__('dashboard.Restaurants Contacts')}}</span>
                </li>
            </ul>
        ...
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h1 class="page-title">{{__('dashboard.Restaurants Contacts Datatable')}}
        </h1>
        <!-- END PAGE TITLE-->
        <!-- END PAGE HEADER-->
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-globe"></i>{{__('dashboard.Restaurants Contacts')}}  </div>
                        <div class="tools"> </div>
                    </div>
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                            ...
                            <tr>
                                ...
                                <th> {{__('dashboard.Restaurants')}}  </th>
                            ...
                            @foreach($contacts as $key=>$contact)
                                <tr>
                                    ...
                                    <td>
                                                              ...
                                                              <a href="{{ route('resturantcontact.show',[$contact->id]) }}" class="btn btn-success btn-sm"><i class="fa fa-eye"></i></a>
