    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <span>{{__('dashboard.Edit Trainer slider')}}</span>
                </li>
            </ul>
        ...
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h1 class="page-title">{{__('dashboard.Edit Trainer slider Form')}}
        </h1>
        <!-- END PAGE TITLE-->
        <!-- END PAGE HEADER-->
            ...
            <div class="col-md-12">
                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    ...
                    <div class="portlet-body">
                        <!-- BEGIN FORM-->
                        <form action="{{route('trainer.sliders.update',$trainerSlider->id)}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" id="ar[title]" name="ar[title]" value="{{$trainerSlider->translate('ar')->title}}" class="form-control" /> </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text"  name="en[title]" id="en[title]" value="{{$trainerSlider->translate('en')->title}}" class="form-control" /> </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <textarea type="text" rows="6"  id="ar[description]" name="ar[description]" class="form-control" >
                                            {{$trainerSlider->translate('ar')->description}}
                                        </textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        {{$trainerSlider->translate('en')->description}}
                                        </textarea>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <select class="form-control" name="trainer_id" id="trainer_id">
                                            @foreach($trainers as $trainer)
                                                <option  {{ $trainer->id == $trainerSlider->trainer->id ? 'selected' : '' }}  value="{{$trainer->id}}">{{$trainer->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <img class="img-responsive img-thumbnail" src="{{$trainerSlider->image }}" style="height: 100px; width: 100px" alt="">                                    </div>
                                </div>
