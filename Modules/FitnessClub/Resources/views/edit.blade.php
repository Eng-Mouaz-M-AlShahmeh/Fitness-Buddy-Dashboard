            ...
            <div class="col-md-12">
                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    ...
                    <div class="portlet-body">
                        <!-- BEGIN FORM-->
                        <form action="{{route('fitness.club.update',$club->id)}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" id="ar[name]" value="{{$club->translate('ar')->name}}" name="ar[name]" class="form-control" /> </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text"  name="en[name]" value="{{$club->translate('en')->name}}" id="en[name]" class="form-control" /> </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <textarea type="text" id="ar[desc]" rows="8" name="ar[desc]" class="form-control">
                                         {{$club->translate('ar')->desc}}
                                        </textarea> </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <textarea type="text"  name="en[desc]" rows="8" id="en[desc]" class="form-control" >
                                           {{$club->translate('en')->desc}}
                                        </textarea> </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <textarea type="text" id="ar[terms]" rows="8" name="ar[terms]" class="form-control">{{$club->translate('en')->terms}}</textarea> </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <textarea type="text"  name="en[terms]" rows="8" id="en[terms]" class="form-control" >{{$club->translate('ar')->terms}}</textarea> </div>
                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <select class="form-control" name="city_id" id="city_id">
                                            @foreach($cities as $city)
                                                <option {{ $city->id == $club->city->id ? 'selected' : '' }}  value="{{$city->id}}">{{$city->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <select class="form-control" name="type">
                                            <option value="0" {{ isset($club) && $club->{'type'} == 0 ? 'selected'  :'' }}>{{__('dashboard.male')}} </option>
                                            <option value="1" {{ isset($club) && $club->{'type'} == 1 ? 'selected'  :'' }}>{{__('dashboard.female')}}</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" id="lat" value="{{$club->lat}}"  name="lat" class="form-control" /> </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" id="lng" value="{{$club->lng}}"  name="lng" class="form-control" /> </div>
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-md-3">{{__('dashboard.Logo')}}
                                    </label>
                                    <div class="col-md-4">
                                        <img class="img-responsive img-thumbnail" src="{{$club->logo }}" style="height: 100px; width: 100px" alt="">                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <img class="img-responsive img-thumbnail" src="{{$club->image }}" style="height: 100px; width: 100px" alt="">                                    </div>
                                </div>
