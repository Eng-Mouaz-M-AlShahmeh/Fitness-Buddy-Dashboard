    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <span>{{__('dashboard.Edit Fitness Club Activity')}}</span>
                </li>
            </ul>
        ...
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h1 class="page-title">{{__('dashboard.Edit Fitness Club Activity Form')}}
        </h1>
        <!-- END PAGE TITLE-->
        <!-- END PAGE HEADER-->
            ...
            <div class="col-md-12">
                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    ...
                    <div class="portlet-body">
                        <!-- BEGIN FORM-->
                        <form action="{{route('activity.update',$activity->id)}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            <div class="form-body">
                                    ...
                                    <div class="col-md-4">
                                        <select class="form-control" name="club_id" id="club_id">
                                            @foreach($clubs as $club)
                                                <option {{ $club->id == $activity->club->id ? 'selected' : '' }}  value="{{$club->id}}">{{$club->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <img class="img-responsive img-thumbnail" src="{{$activity->icon }}" style="height: 100px; width: 100px" alt="">                                    </div>
                                </div>
