    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <span>{{__('dashboard.Edit User')}}</span>
                </li>
            </ul>
        ...
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h1 class="page-title">{{__('dashboard.Edit User Form')}}
        </h1>
        <!-- END PAGE TITLE-->
        <!-- END PAGE HEADER-->
                        ...
                        <form action="{{route('user.update',$user->id)}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="form-body">
                                ...
                                <div class="alert alert-success display-hide">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" id="name" name="name" class="form-control" value="{{$user->name}}"  /> </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" id="mobile" name="mobile" class="form-control" value="{{$user->mobile}}"  /> </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        id="password" class="form-control" value="{{$user->password}}"  />  </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text"  name="length" id="length" class="form-control"  value="{{$user->length}}" /> </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" id="weight" name="weight" class="form-control"   value="{{$user->weight}}"  /> </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-3">{{__('dashboard.Date of Birth')}}
                                    </label>
                                    <div class="col-md-4">
                                        <input type="date"  name="age" id="dob" class="form-control"  value="{{$user->age}}"  /> </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                         <img class="img-responsive img-thumbnail" src="{{$user->image }}" style="height: 100px; width: 100px" alt="">                                   
